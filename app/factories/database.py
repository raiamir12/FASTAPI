...
class Database(object):
    def __init__(self):
        self.client = MongoClient("mongodb://localhost:27017/?readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false")  # configure db url
        self.db = self.client["tests"]  # configure db name
