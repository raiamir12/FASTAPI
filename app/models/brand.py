...
class Car(object):
    ...
    def __init__(self):
        ...
        self.create_required_fields = ["name", "description","int"]

        # Fields optional for CREATE
        self.create_optional_fields = ["name", "description","int"]

        # Fields required for UPDATE
        self.update_required_fields = ["name", "description","int"]

        # Fields optional for UPDATE
        self.update_optional_fields = ["name", "description","int"]
